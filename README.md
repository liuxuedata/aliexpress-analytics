...
- 自运营数据明细与运营分析页已移除顶部商品总数，计数仅在需要时在产品视图内部使用
...
- 自运营与全托管数据明细页新增“曝光商品数”KPI，Ozon 数据明细页新增“展示商品数”KPI，用于统计当前周期内曝光量大于 0 的商品数量并与上周期对比
- 自运营与全托管运营分析页的 Top10 访客比和加购→支付转化率柱状图支持双击跳转到对应产品分析页
