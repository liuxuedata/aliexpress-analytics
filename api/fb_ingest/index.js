...
const XL = {
  ...
  ctr_all: ['点击率（全部）', 'ctr（全部）', 'allctr'],
  ctr_link: ['链接点击率', 'linkctr'],
...
module.exports = async (req, res) => {
  ...
  try {
    ...
    const payload = rows.map(r => {
      const row = {
        site_id: siteId,
        date: I.date >= 0 ? r[I.date] : (I.row_start_date >= 0 ? r[I.row_start_date] : null),
        ...
        ctr_all: toNum(I.ctr_all >= 0 ? r[I.ctr_all] : null),
        unique_all_ctr: toNum(I.unique_all_ctr >= 0 ? r[I.unique_all_ctr] : null),
        ctr_link: toNum(I.ctr_link >= 0 ? r[I.ctr_link] : null),
