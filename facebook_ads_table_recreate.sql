-- 删除现有的Facebook Ads表（如果存在）
DROP TABLE IF EXISTS public.independent_facebook_ads_daily;
...
-- 创建索引
CREATE INDEX idx_facebook_ads_site_day ON public.independent_facebook_ads_daily (site, day);
CREATE INDEX idx_facebook_ads_campaign ON public.independent_facebook_ads_daily (site, campaign_name);
CREATE INDEX idx_facebook_ads_adset ON public.independent_facebook_ads_daily (site, adset_name);
CREATE INDEX idx_facebook_ads_date_range ON public.independent_facebook_ads_daily (day);
